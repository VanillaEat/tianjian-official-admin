<template>
    <div class="topbar-container" data-fixed-calc-width>
        ...
        <div class="left-box">
            ...
            <div
                v-if="(['side', 'head', 'single'].includes(settingsStore.menu.menuMode) && settingsStore.topbar.enableSidebarCollapse)"
                class="sidebar-collapse" :class="{'is-collapse': settingsStore.menu.sidebarCollapse}"
